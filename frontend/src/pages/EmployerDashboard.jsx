...
const EmployerDashboard = () => {
    ...
    const handleViewApplications = async (jobId) => {
        try {
            ...
            alert("Không thể lấy danh sách ứng viên");
        }
    };
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    <div className="list-group">
                        <h5 className="list-group-item list-group-item-action active">Tin tuyển dụng của bạn</h5>
                        {jobs.map(job => (
                            <button 
                                key={job._id}
                        ...
                        <tbody>
                            {applications.length > 0 ? applications.map(app => (
                                <tr key={app._id}>
                                    ...
                                    <td><a href={app.resume} target="_blank" rel="noreferrer">Xem CV</a></td>
                                    <td>
                            ...
                            )) : <tr><td colSpan="4" className="text-center">Chọn một job hoặc chưa có ứng viên nào.</td></tr>}
                        </tbody>
                    </table>
                </div>
            </div>
